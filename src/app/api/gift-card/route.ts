...
export async function POST(request: Request) {
  try {
    ...
    "componentType":"girl"; //or a "boy", "anniversary", "child", "graduation", "invitation", "thank_you", "get_well" - Just 8 options!, - do not create new component types. the only types are the ones I listed,   
    "poemabout": "  
